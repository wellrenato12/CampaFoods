...
export function CardPopularItems({ name, restaurant, price, image }: CardPopularItemsProps) {
  return (
    <div className="w-72 flex flex-col gap-2 text-[22px] my-8 sm:my-0">
      <img loading="lazy" className='rounded-2xl size-[283px] object-cover' src={image} alt="" />
      ...
      <button className='py-3 bg-[#f17228] text-white rounded-lg transition-all duration-300 hover:bg-[#e7631a]'>
        Peça agora
      </button>
